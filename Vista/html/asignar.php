...
<head>
  ...
  <title>Sistema de Gestión Odontológica</title><link rel="stylesheet" type="text/css" href="../Vista/css/estilos.css">
    ...
    <div id="contenido">
      ...
      <form id="frmasignar" action="index.php?accion=guardarCita" method="post">
        <table>
          ...
          <tr>
            ...
            <td>
              <select id="medico" name="medico">
                ...
                <option value="12345">12345-Pepito Pérez</option><option value="67890">67890-Pepita Mendieta</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            <td>Hora:</td>
            <td><select id="hora" name="hora"><option value="-1" selected="selected">---Seleccione la hora ---</option><option>08:00:00</option><option>08:20:00</option><option>08:40:00</option><option>09:00:00</option></select></td>
          </tr>
